...
### 5. Пользователь получает готовый отчёт

После завершения анализа система автоматически отправляет пользователю email-отчёт.

В отчёте содержатся:

- сравнение показателей без ИИ и с ИИ;
- индекс эффективности IE;
- уровень эффекта;
- список выявленных рисков;
- P, V и R по каждому риску;
- меры управления;
- Rmax;
- уровень риска;
...
### 6. Итоговое управленческое решение
